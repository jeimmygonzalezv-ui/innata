...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-card dark:border-border/50 bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
  ...
  return (
    <div
      className={cn(
        ...
        className,
        showGradient &&
          "bg-card/50 dark:bg-card/80 [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
      )}
    >
      {children}
    </div>
...
const Container = ({
  ...
  return (
    <div
      className={cn(
        `h-16 w-16 rounded-full flex items-center justify-center bg-card/80
